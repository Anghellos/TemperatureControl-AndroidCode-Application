...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (connectionDatabase.connectionOpen()){
            Toast.makeText(getApplicationContext(), "Connected to Azure", Toast.LENGTH_LONG).show();
        }else{
            Toast.makeText(getApplicationContext(), "Failed Connect to Azure", Toast.LENGTH_LONG).show();
        }

        ChangeFragment(_dashboard);
